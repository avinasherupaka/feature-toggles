...
//     return request
//         .post(`${base}/api/admin/features/toggle.disabled/toggle/dev/on`)
//         .expect('Content-Type', /json/)
//         .expect(200)
//         .expect(res => {
//             t.true(res.body.nonProdEnabled === true);
//         });
// });
...
//     return request
//         .post(`${base}/api/admin/features/toggle.enabled/toggle/dev/off`)
//         .expect('Content-Type', /json/)
//         .expect(200)
//         .expect(res => {
//             t.true(res.body.nonProdEnabled === false);
//         });
// });
